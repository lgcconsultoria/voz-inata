    ...
    <AppShell current="/agenda">
      <div className="container-wide py-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <h1 className="font-display text-3xl text-verde sm:text-4xl">Agenda</h1>
            <p className="mt-2 max-w-xl text-tinta/85">
          ...
          {events.map(e => (
            <Card key={e.title} className="flex flex-col gap-4 md:flex-row md:items-center md:gap-6">
              <div className="flex shrink-0 items-center gap-4 md:flex-col md:items-start">
                <p className="font-display text-3xl text-terracota">{e.day}</p>
              ...
              <div className="flex-1">
                ...
                <CardTitle className="mt-1 text-lg">{e.title}</CardTitle>
                <CardContent className="mt-1 text-argila">
                  Apresentado por {e.host}
                </CardContent>
              </div>
              <div className="flex flex-col items-stretch gap-2 md:items-end">
                <span className="rounded-full border border-areia px-3 py-1 text-xs text-tinta">
                  {e.badge}
                </span>
